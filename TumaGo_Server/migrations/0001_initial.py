...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('earnings', models.DecimalField(decimal_places=2, default=0.0, max_digits=100000)),
                ('charges', models.DecimalField(decimal_places=2, default=0.0, max_digits=100000)),
                ('profit', models.DecimalField(decimal_places=2, default=0.0, max_digits=100000)),
