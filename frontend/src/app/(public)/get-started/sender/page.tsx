...
export default function SenderSignupPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      if (res.ok) {
        router.push("/get-started/welcome?role=sender");
      } else {
        ...
        <div className="rounded-2xl border border-gray-100 bg-white p-8 shadow-lg sm:p-10">
          ...
          <div className="mb-8 text-center">
            ...
            <p className="mt-2 text-sm text-text-muted">
              Step {step} of 2 — {step === 1 ? "Personal info" : "Account details"}
            </p>
          </div>
            ...
            {step === 1 && (
              <div className="space-y-5">
                ...
                <button
                  type="button"
                  onClick={goToStep2}
                  className="mt-2 flex w-full items-center justify-center gap-2 rounded-xl bg-accent px-6 py-3.5 text-sm font-semibold text-white transition-all hover:bg-orange-600 hover:shadow-lg"
                >
                  Continue
              ...
              <div className="space-y-5">
                ...
                <div className="mt-2 flex gap-3">
                  ...
                  <button
                    type="submit"
                    disabled={loading}
                    className="flex flex-1 items-center justify-center gap-2 rounded-xl bg-accent px-6 py-3.5 text-sm font-semibold text-white transition-all hover:bg-orange-600 hover:shadow-lg disabled:opacity-60 disabled:cursor-not-allowed"
                  >
                    {loading ? (
