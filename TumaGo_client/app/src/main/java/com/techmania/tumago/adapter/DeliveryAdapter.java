...
public class DeliveryAdapter extends RecyclerView.Adapter<DeliveryAdapter.cardviewholder> {
    ...
    public void onBindViewHolder(@NonNull cardviewholder holder, int position) {
        holder.delivery_id.setText(String.format("id: %s", arrayList.get(position).getDelivery_id()));
        ...
        switch (vehicleType) {
            case "scooter":
                ...
                break;
            case "truck":
                holder.image.setImageResource(R.drawable.truckm);
                break;
            case "van":
                holder.image.setImageResource(R.drawable.vanm);
                break;
            default:
